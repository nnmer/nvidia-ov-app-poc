...
-- Apps: for each app generate batch files and a project based on kit files (e.g. msft.khi.viewer.kit)
define_app("msft.khi.viewer")
-- define_app("msft.khi.viewer.viewport")
-- define_app("msft.khi.viewer.editor")
